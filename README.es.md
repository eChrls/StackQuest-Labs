...
| Lab 04 — Angular + Spring Enterprise | Angular, TypeScript, Java, Spring Boot, PostgreSQL                         | Full-stack enterprise, validación, autorización e integración               | `⏳ PENDING` | `⏳ PENDING`    | `⏳ PENDING` (opcional/comunidad) |
