...
The current nine Labs are the initial content set. They deliberately include observable baseline failures: reproduce the symptom, form a hypothesis, use tests and logs, make a small change, and explain the trade-off. See each local README for candidate guidance, acceptance criteria, Hint 1/2/3, guided debugging, mentor spoilers, troubleshooting and validation evidence.
